package com.example.apartments.modules.likedApartments
...
import com.example.apartments.databinding.FragmentLikedApartmentsBinding
...
class LikedApartmentsFragment : Fragment() {
    private var TAG = "LikedApartmentsFragment"

    private var _binding: FragmentLikedApartmentsBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentLikedApartmentsBinding.inflate(inflater, container, false)
        viewModel = ViewModelProvider(this)[ApartmentsViewModel::class.java]

        progressBar = binding.progressBar

        progressBar?.visibility = View.VISIBLE
        viewModel.apartments = viewModel.getAllLikedApartments()
        progressBar?.visibility = View.GONE

        apartmentsRecyclerView = binding.rvLikedApartmentsFragmentList
